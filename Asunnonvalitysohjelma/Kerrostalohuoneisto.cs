...
{
    class Kerrostalohuoneisto : Asunto
    {
        private int nro1;
        private double nro2;

        public Kerrostalohuoneisto() { }

        public Kerrostalohuoneisto(string Katuosoite, string Postinumero, string Kunta, string Asuntotyyppi, string Huoneistotyyppi, int Pinta_ala, string Rahoitustapa, double Kustannus1, double Kustannus2, string Vapautuu, string Status, string Muutto)
        ...
        public override void KysyTiedot() // kysytään asunnon perustiedot
        {
            ...
            Asuntotyyppi = "kerrostalohuoneisto";

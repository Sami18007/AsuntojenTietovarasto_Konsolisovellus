...
{
    class Paritalohuoneisto : Asunto
    {
        private int nro1;
        private double nro2;

        public Paritalohuoneisto() { }

        public Paritalohuoneisto(string Katuosoite, string Postinumero, string Kunta, string Asuntotyyppi, string Huoneistotyyppi, int Pinta_ala, string Rahoitustapa, double Kustannus1, double Kustannus2, string Vapautuu, string Status, string Muutto)
        ...
        public override void KysyTiedot() // kysytään asunnnon perustiedot
        {
            ...
            Asuntotyyppi = "paritalohuoneisto";
        ...
        {
            if (Rahoitustapa == "omistusasunto") // tulostusmuoto, jos rahoitustapa on "omistusasunto"
            {
            ...
            else // tulostusmuoto, jos rahoitustapa on "vuokra-asunto"
            {

...
namespace Asunnonvalitysohjelma
{
    class Omakotitalo : Asunto
    {
        ...
        public Omakotitalo(string Katuosoite, string Postinumero, string Kunta, string Asuntotyyppi, string Huoneistotyyppi, int Pinta_ala, string Rahoitustapa, double Kustannus1, double Kustannus2, string Vapautuu, string Status, string Muutto)
